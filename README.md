...
## Overview
Welcome to **Oiram**, a Java-based 2D platformer developed to showcase engaging gameplay, dynamic mechanics, and creative level design. This project is built using Java and leverages tools like Git and GitHub for version control and collaboration.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/QuocAnhDiEm/OOP-project.git
...
- **Email**: ititwe22003@student.hcmiu.edu.vn
- **GitHub**:(https://github.com/QuocAnhDiEm/OOP-project.git)
